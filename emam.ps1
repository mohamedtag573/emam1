...
function Show-Banner {
    ...
    Write-Host "   ::                                                 ::" -ForegroundColor DarkCyan
    Write-Host "   ::    ______  __  __   ______   __    __          ::" -ForegroundColor Cyan
    Write-Host "   ::   /\  ___\/\ \/\ \ /\  __ \ /\ '-./  \        ::" -ForegroundColor Cyan
    Write-Host "   ::   \ \  __\\ \ \_\ \\ \  __ \\ \ \-./\ \       ::" -ForegroundColor White
    Write-Host "   ::    \ \_____\ \_____\\ \_\ \_\\ \_\ \ \_\      ::" -ForegroundColor DarkGray
    Write-Host "   ::     \/_____/\/_____/ \/_/\/_/ \/_/  \/_/      ::" -ForegroundColor DarkGray
    Write-Host "   ::                                                 ::" -ForegroundColor DarkCyan
    Write-Host "   ::        Professional IT Toolkit  |  v3.2        ::" -ForegroundColor DarkCyan
    Write-Host "   ::              by  E M A M                       ::" -ForegroundColor Cyan
    Write-Host "   ::                                                 ::" -ForegroundColor DarkCyan
    Write-Host "   :::::::::::::::::::::::::::::::::::::::::::::::::::::" -ForegroundColor DarkCyan
    Write-Host ""
}
...
function Run-Option($num) {
    $url = "https://raw.githubusercontent.com/mohamedtag573/emam1/main/$num"
    try {
        Write-Host ""
        ...
        Write-Host ""
        Write-Host "    [!] Script not available or no internet connection." -ForegroundColor Red
        Write-Host ""
        Start-Sleep 2
    }
}
...
do {
    ...
    switch ($c) {
        "1"  { Run-Option "01_pre_check.ps1" }
        "01" { Run-Option "01_pre_check.ps1" }
        "2"  { Run-Option "02_install_apps.ps1" }
        "02" { Run-Option "02_install_apps.ps1" }
        "3"  { Run-Option "03_activation.ps1" }
        "03" { Run-Option "03_activation.ps1" }
        "4"  { Run-Option "04_windows_update.ps1" }
        "04" { Run-Option "04_windows_update.ps1" }
        "5"  { Run-Option "05_post_check.ps1" }
        "05" { Run-Option "05_post_check.ps1" }
        "6"  { Run-Option "06_cleanup.ps1" }
        "06" { Run-Option "06_cleanup.ps1" }
        "7"  { Run-Option "07_system_repair.ps1" }
        "07" { Run-Option "07_system_repair.ps1" }
        "8"  { Run-Option "08_error_handler.ps1" }
        "08" { Run-Option "08_error_handler.ps1" }
        "9"  { Run-Option "09_hardware_info.ps1" }
        "09" { Run-Option "09_hardware_info.ps1" }
